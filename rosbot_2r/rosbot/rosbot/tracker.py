...
class OptimizedTrackerNode(Node):
    def __init__(self):
        ...
        self.create_subscription(Image, '/processed/depth/image', self.depth_callback, qos)
                ...
                for box in detections:
                    ...
                    if class_name in self.valid_names:
                        ...
                        if self.depth_image is not None:
                            ...
                            if 0 <= center_x < w_d and 0 <= center_y < h_d:
                                depth_val = self.depth_image[center_y, center_x]
                                if depth_val > 0:
                                    x3d, y3d, z3d = self.pixel_to_3d(center_x, center_y, depth_val)
